...
class TestGame < Test::Unit::TestCase
  ...
  def test_room()
    gold = Map::Room.new("GoldRoom::Room", """This room has gold in it you can grab. There's a door to the north.""")
  ...
  def test_gothon_game_map()
    assert_equal(Map::SHOOT, Map::START.go('shoot!'))
    assert_equal(Map::DODGE, Map::START.go('dodge!'))
